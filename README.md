...
[![](https://img.shields.io/badge/downloads-108MB-orange)](https://github.com/jimmybytes/pansen-panel/releases/latest)
![](https://img.shields.io/badge/coverage-100%25-green)
### Release
Riot Live Client Data API Panel **[Download Latest Release](https://github.com/jimmybytes/pansen-panel/releases/latest)**

### Build from source
1. Clone repository 
    ```
    $ git clone https://github.com/jimmybytes/pansen-panel.git
    ```
